...
func show_tutorial():
	var ic_a := Utils.get_node_screen_position(GameManager.level.get_node("Marvy/FoodDispenser"), Vector2(0, -18))
	var ic_b := Utils.get_node_screen_position(GameManager.level.get_node("Marvy/FoodDispenser2"), Vector2(0, -18))
	var text_1_pos = Utils.get_node_ui_position(GameManager.level.get_node("Marvy/FoodDispenser"), Vector2(0, 54))
	TutorialManager.pause()
	TutorialManager.clear_highlights()
	TutorialManager.clear_text()
	TutorialManager.highlight_slot(ic_a, ic_b, 24.0)
	TutorialManager.highlight_node(GameManager.level.get_node("Marvy"), 64.0, Vector2(0, -42))
